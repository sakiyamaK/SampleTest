...
//            counter = Counter(count: 2, counterStorageProtocol: counterStorageMock)
//          }
//
//          context("#increment") {
//            it("CounterStorageProtocol.save()が引数3で呼び出されること") {
//              counter.increment()
//              expect(counterStorageMock.latestSaveCount) == 3
//            }
//          }
//
//          context("#decrement") {
//            it("CounterStorageProtocol.save()が引数1で呼び出されること") {
//              counter.decrement()
//              expect(counterStorageMock.latestSaveCount) == 1
//            }
//          }
//        }
//      }
